...
def generate_launch_description():
    # Use the proper package share directory
    try:
    ...
    # URDF file (processed from XACRO)
    ...
    return LaunchDescription([
        ...
        # Joint State Publisher (for when GUI is false)
        Node(
        ...
        # Joint State Publisher GUI (useful for URDF testing)
        Node(
